...
download_data_params = params["download_data"]
num_batches = download_data_params["num_batches"]
combination_method = download_data_params["combination_method"]
selected_batches = download_data_params["selected_batches"]
...
def download_data(config, root):
    ...
    os.makedirs(os.path.join(test_batch_dir, "images"), exist_ok=True)  
